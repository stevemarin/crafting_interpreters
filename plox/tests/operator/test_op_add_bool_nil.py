...
# Base cases from https://github.com/munificent/craftinginterpreters/blob/master/test/operator/add_bool_nil.lox
TEST_SRC = dedent(
    """\
...
def test_add_bool_nil(capsys: pytest.CaptureFixture) -> None:
    interpreter = Lox()
